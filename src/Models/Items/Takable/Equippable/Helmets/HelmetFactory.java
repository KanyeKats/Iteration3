...
public enum HelmetFactory {
    BLUE_PHAT(3000) {
        ...
        public Helmet createInstance() {
            ...
            return new Helmet(ImageLoader.loadImage("./res/items/blue_phat.png"), new StatModificationList(buff), "Blue Party Hat", "A rare blue party hat, you must be an OG player", req, 3000, 75);
        }
    },
    IRON_HELMET(3001) {
        @Override
        public Helmet createInstance() {
            ...
            StatRequirement req = new StatRequirement(Stat.DEFENSIVE_RATING, 0);
            return new Helmet(ImageLoader.loadImage("./res/items/iron_helm.png"), new StatModificationList(buff), "Iron Helmet", "A sturdy iron helmet to protect your noggin'", req, 3001, 50);
        }
    },
    PURPLE_PHAT(3002) {
        @Override
        public Helmet createInstance() {
            ...
            StatRequirement req = new StatRequirement(Stat.DEFENSIVE_RATING, 0);
            return new Helmet(Assets.PLACEHOLDER, new StatModificationList(buff), "Purple Party Hat", "A rare purple party hat, you gotta be OG", req, 3002, 75);
        }
    },
    SANTA_HAT(3003) {
        @Override
        public Helmet createInstance() {
            ...
            StatRequirement req = new StatRequirement(Stat.DEFENSIVE_RATING, 0);
            return new Helmet(Assets.PLACEHOLDER, new StatModificationList(buff), "Santa Hat", "A glorious santa hat which is sure to protect you from damage.", req, 3003, 100);
        }
    };

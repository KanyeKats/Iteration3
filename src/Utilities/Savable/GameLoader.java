...
public class GameLoader {
    ...
    public static final Point3D DEFAULT_STARTING_POINT = new Point3D(3, 0, 4); // Just made sure this was a valid point in the default map. Should be done better probably.
